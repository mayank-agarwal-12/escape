            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                {!! Form::model ($adminUserObj,['method'=>'PATCH' , 'action'=>['Adminpanel\AdminPanelUser@update',$adminUserObj->id],'enctype'=>"multipart/form-data"]) !!}
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status',['Active','Inactive'],$adminUserObj->status,['class'=>'form-control']) !!}
                                </div>
                                ...
                                {!! Form::open(['method'=>'GET' , 'action'=>'Adminpanel\AdminPanelUser@index']) !!}
