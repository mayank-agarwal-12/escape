            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                {!! Form::model ($eventList,['method'=>'PATCH' , 'action'=>['Adminpanel\Events@update',$eventList->id],'enctype'=>"multipart/form-data"]) !!}
                                {{csrf_field()}}
                                ...
                                {!! Form::open(['method'=>'GET' , 'action'=>'Adminpanel\Events@index']) !!}
